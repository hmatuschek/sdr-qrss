Summary: A QRSS receiver using libsdr.
...
%description
A simple QRSS receiver using libsdr.
...
%files
%defattr(-, root, root, -)
%attr(755, root, root) %{_prefix}/bin/sdr-qrss
%{_prefix}/share/applications/sdr-qrss.desktop
%{_prefix}/share/icons/sdr-qrss.svg
